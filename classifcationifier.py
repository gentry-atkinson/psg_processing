...
if __name__ == '__main__':
    for channel in channels:
        x_train = np.load(f'{channel}_Supervised CNN_train_features_sub_1to50.npy')
        x_val = np.load(f'{channel}_Supervised CNN_validation_features_sub_1to50.npy')
        x_test = np.load(f'{channel}_Supervised CNN_test_features_sub_1to50.npy')
